...
main(){ //main sebagai fungsi utama
	int pil,harga,subtotal,jumlah,total2,bayar,kembalian,diskon,subtotal1,jarak,diskon1,disong1; //variabel tipe data int
	char nomor,menu[30],ulang; //variabel tipe data char
	...
	if (nomor==1) { // srtcmp digunakan untuk membandingkan 2 string
		strcpy(menu,"AYAM GEPREK"); //strcpy untuk menyalin data string mengeluarkan 
		harga=21000;
	}
	else if (nomor==2) { // srtcmp digunakan untuk membandingkan 2 string
		strcpy(menu,"AYAM GORENG"); //strcpy untuk menyalin data string
		harga=17000;
	}
	else if (nomor==3) { // srtcmp digunakan untuk membandingkan 2 string
		strcpy(menu,"UDANG GORENG");
		harga=19000;
	}
	else if (nomor==4) { // srtcmp digunakan untuk membandingkan 2 string
